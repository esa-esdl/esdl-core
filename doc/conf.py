...
# -*- coding: utf-8 -*-
#
# CAB-LAB documentation build configuration file, created by
...
epub_title = project
epub_author = [author1, author2, author3]
epub_publisher = [author1, author2, author3]
