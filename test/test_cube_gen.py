...
class MainTest(TestCase):
    ...
    def test_parse_source_arg(self):
        ...
        self.assertEqual(('', None, None, 'SOURCE name must not be empty'), _parse_source_arg(os.pathsep))
        self.assertEqual(('', None, None, 'SOURCE name must not be empty'), _parse_source_arg(os.pathsep + 'a'))
        self.assertEqual(('a', [['']], OrderedDict(), None), _parse_source_arg('a' + os.pathsep))
        self.assertEqual(('a', [['b']], OrderedDict(), None), _parse_source_arg('a' + os.pathsep + 'b'))
